...
class Timer{
    ...
    start = () => {
        ...
        resetBtn.style.display = "none";
        hoursTextField.disabled = true;
        minutesTextField.disabled = true;
        secondsTextField.disabled = true;
    ...
    stop = () => {
        ...
        hoursTextField.disabled = false;
        minutesTextField.disabled = false;
        secondsTextField.disabled = false;
    }
    pause = () => {
        clearTimeout(this.setIntID1);
        clearTimeout(this.setIntID2);
    ...
    getTime(){
        let timeSec =
            (
                parseInt(hoursTextField.value) * 3600 +
                parseInt(minutesTextField.value) * 60 +
                parseInt(secondsTextField.value)
            );
        return timeSec;
    }
    ...
    setTime(newTimeSec){
        ...
        let newTimeSec2 = newTimeSec - timeHours * 3600; // hoursTextField = 0 ok
        let timeMinutes = Math.floor(newTimeSec2 / 60);
        let timeSeconds = newTimeSec2 - timeMinutes * 60; // minutes = 0 ok

        hoursTextField.value = timeHours;
        minutesTextField.value = timeMinutes;
        secondsTextField.value = timeSeconds;
...
function init(){
    ...
    hoursTextField.addEventListener("change", timer.showTimeAtStart);
    minutesTextField.addEventListener("change", timer.showTimeAtStart);
    secondsTextField.addEventListener("change", timer.showTimeAtStart);
