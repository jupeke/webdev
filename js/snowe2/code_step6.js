...
var transform = ["transform", "msTransform", "webkitTransform",
    ...
    for(i=0; i<this.snowFlakes.length; i++){
      ...
      if(flakeElem){
        ...
        if(flake.y > groundLevel){
          let random_x = Math.floor((Math.random() * getWindowWidth()));
          flake.sendFlakeUp(random_x);
          main.changeNumberOfLives(-1);
        }
      }
    }
    // But this weirdy thing called arrow function (ES6) works! It
    // preserves the local scope of "this". See
    // http://stackoverflow.com/questions/36209784/variable-inside-
    // settimeout-says-it-is-undefined-but-when-outside-it-is-defined
