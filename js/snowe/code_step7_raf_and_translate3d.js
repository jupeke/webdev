...
class SnowFlake extends MovingObject{
  ...
  // This happens quite seldom, so changing CSS should
  // be a problem.
  sendFlakeUp(rand_x){
...
class MainControl{
  ...
  letItSnow(){
    ...
    let fallingStep = snowFallSpeed*1.5;
  ...
  showGoodBye(){
    ...
    b.innerHTML = "<div id='goodbyetext'>Good bye!</div>";
  }
}
